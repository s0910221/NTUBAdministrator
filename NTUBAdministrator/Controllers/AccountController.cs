    ...
    public class AccountController : Controller
    {
        ...
        */
        ...
        public ActionResult Login(LoginViewModel user)
        {
            if (ModelState.IsValid)
            {
                ...
                if (details.FirstOrDefault() != null)
                {
                    ...
                    return RedirectToAction("ActivityManagement", "Activities");
                }
            }
            else
            {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var result = await SignInManager.PasswordSignInAsync(model.AccountID, model.Password, false, shouldLockout: false);
            switch (result)
            {
        ...
        */
        ...
        public async Task<ActionResult> Register(UserAccount model)
        {
            if (ModelState.IsValid)
            {
                var user = new UserAccount {AccountID = model.AccountID, Password = model.Password, UserName = model.UserName, Email = model.Email, Enabled = "1"};
